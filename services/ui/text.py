...
_EN = {
    ...
    "trace_terminal": "decisions, one per line",
    "approval_interrupted": "approval interrupted — approve again to finish it",
    "rejection_interrupted": "rejection interrupted — reject again to finish it",
...
_ES = {
    ...
    "trace_terminal": "decisiones, una por línea",
    "approval_interrupted": "aprobación interrumpida — aprobá de nuevo para terminarla",
    "rejection_interrupted": "rechazo interrumpido — rechazá de nuevo para terminarlo",
